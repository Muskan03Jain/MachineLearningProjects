...
#make sure you change the path before run the code
loaded_model = joblib.load(r"C:\Users\Lenovo\Muskan\Ml\Machine-Learning-Projects\KNN\Iris_data\knn_iris.pkl")
